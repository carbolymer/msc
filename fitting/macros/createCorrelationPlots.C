...
int createCorrelationPlots()
{
	...
	loadCentralityBin(
		"/home/carbolymer/workspace/bsc/tpi_output/lhc0005",
		"hHKM",
		"0-5%",
		pipi, pp, kk, kp, pik, piku, pip, pipu);

	loadCentralityBin(
		"/home/carbolymer/workspace/bsc/tpi_output/lhc1020",
		"hHKM",
		"10-20%",
		pipi, pp, kk, kp, pik, piku, pip, pipu);

	loadCentralityBin(
		"/home/carbolymer/workspace/bsc/tpi_output/lhc2030",
		"hHKM",
		"20-30%",
		pipi, pp, kk, kp, pik, piku, pip, pipu);

	loadCentralityBin(
		"/home/carbolymer/workspace/bsc/tpi_output/lhc3040",
		"hHKM",
		"30-40%",
		pipi, pp, kk, kp, pik, piku, pip, pipu);

	loadCentralityBin(
		"/home/carbolymer/workspace/bsc/tpi_output/epos_0005",
		"EPOS",
		"0-5%",
		pipi, pp, kk, kp, pik, piku, pip, pipu);

	loadCentralityBin(
		"/home/carbolymer/workspace/bsc/tpi_output/epos_1020",
		"EPOS",
		"10-20%",
		pipi, pp, kk, kp, pik, piku, pip, pipu);

	loadCentralityBin(
		"/home/carbolymer/workspace/bsc/tpi_output/epos_2030",
		"EPOS",
		"20-30%",
		pipi, pp, kk, kp, pik, piku, pip, pipu);
	...
	loadCentralityBin(
		"/home/carbolymer/workspace/bsc/tpi_output/epos_3040",
		"EPOS",
		"30-40%",
		pipi, pp, kk, kp, pik, piku, pip, pipu);
